# Pinned opencv formula for CI use.
#
# This is opencv 4.9.0 revision 5, pinned to be compatible with the
# `opencv` Rust crate 0.95.x whose binding generator panics on OpenCV 4.10+
# with "unreachable code: Any other kind of class shouldn't be generated".
#
# The `root_url` in the bottle block points to the official Homebrew CDN so
# pre-built bottles are downloaded rather than building from source.
#
# Source: Homebrew/homebrew-core commit ff2bf38fa03acc2148c01843dffc6d31d6377c42
# (opencv: update 4.9.0_5 bottle, 2024-03-24)
class Opencv < Formula
  ...
  bottle do
    # Point to the official Homebrew bottle CDN so the pre-built bottles for
    # this exact version can be downloaded from a custom tap.
